document.addEventListener('DOMContentLoaded', () => {
    ...
    const commands = [
        ...
        { title: 'Go to Experience', href: '#experience', icon: '<svg viewBox="0 0 16 16" width="16" height="16"><path d="M2 2.5A2.5 2.5 0 0 1 4.5 0h8.75a.75.75 0 0 1 .75.75v12.5a.75.75 0 0 1-.75.75h-2.5a.75.75 0 0 1 0-1.5h1.75v-2h-8a1 1 0 0 0-.714 1.7.75.75 0 1 1-1.072 1.05A2.495 2.495 0 0 1 2 11.5Zm10.5-1v9.763c-.056.004-.112.008-.168.008a2.5 2.5 0 0 0-1.082.247V1.5H4.5a1 1 0 0 0-1 1v9.066A1.002 1.002 0 0 0 4.5 12h8.25Z"></path></svg>' },
        { title: 'Go to Education', href: '#education', icon: '<svg viewBox="0 0 16 16" width="16" height="16" fill="currentColor"><path d="M7.78 1.08a.75.75 0 0 1 .44 0l6.25 2a.75.75 0 0 1 0 1.44l-1.92.62v2.11a2.5 2.5 0 0 1-1.3 2.2l-2.75 1.5a2.5 2.5 0 0 1-2.5 0l-2.75-1.5A2.5 2.5 0 0 1 2 8.25V5.76L.03 5.12a.75.75 0 0 1 0-1.44l6.25-2ZM3.5 7.11v1.14c0 .52.27 1 .73 1.25l2.75 1.5a1 1 0 0 0 1 0l2.75-1.5c.46-.25.73-.73.73-1.25V7.11L8 8.07 3.5 7.11ZM8 2.37 3.32 3.87 8 5.37l4.68-1.5L8 2.37Z"></path></svg>' },
        { title: 'Go to Achievements', href: '#achievements', icon: '<svg viewBox="0 0 16 16" width="16" height="16"><path d="M11.28 6.78a.75.75 0 0 0-1.06-1.06L7.25 8.69 5.78 7.22a.75.75 0 0 0-1.06 1.06l2 2a.75.75 0 0 0 1.06 0l3.5-3.5Z"></path><path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0Zm-1.5 0a6.5 6.5 0 1 0-13 0 6.5 6.5 0 0 0 13 0Z"></path></svg>' },
